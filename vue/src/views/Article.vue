<template>
    <div>
        ...
        <el-card>
            ...
            <el-dialog title="日志信息" :visible.sync="dialogFormVisible" width="60%" style="text-align: center;">
            ...
            <el-dialog title="日志信息" :visible.sync="viewDialogVis" width="60%" style="text-align: center;">
                <el-card>
                    <div>
