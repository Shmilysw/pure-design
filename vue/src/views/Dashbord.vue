                        ...
                        <div class="boxnav" style="height: 200px;">
                            <table class="table1" width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>类型2</td>
                                        <td><span class="text-w">500万</span></td>
                                        <td><span class="text-b">400万</span></td>
                                        <td>
                                            <div class="text-d">↑25%</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>类型2</td>
                        ...
                        <div class="boxnav" style="height: 200px;">
                            <table class="table1" width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>类型3</td>
                                        <td><span class="text-w">800万</span></td>
                                        <td><span class="text-b">700万</span></td>
                                        <td>
                                            <div class="text-d">↑14%</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>类型3</td>
                        ...
                        <div class="boxnav" style="height: 200px;">
                            <table class="table1" width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>类型4</td>
                                        <td><span class="text-w">200万</span></td>
                                        <td><span class="text-b">150万</span></td>
                                        <td>
                        ...
                        <div class="boxnav">
                            <table class="table1" width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>类型5</td>
                                        <td><span class="text-b">60%</span></td>
                                    </tr>
                                    <tr>
                                        <td>类型5</td>
                                        <td><span class="text-b">60%</span></td>
...
.mapc {
    background: url(./show/images/bg3.png) no-repeat center center;
...
.mapnav div {
    background: url(./show/images/bg1.png) no-repeat;
