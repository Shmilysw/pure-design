<template>
  <div>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"
      ...
      <el-table-column prop="id" label="数据库ID" width="80"></el-table-column>
      <el-table-column prop="name" label="数据库名"></el-table-column>
      <el-table-column prop="score" label="数据库表数量"></el-table-column>
      <el-table-column prop="times" label="数据库描述"></el-table-column>
      <el-table-column prop="teacher" label="数据库类型"></el-table-column>
      ...
      <el-table-column label="操作" width="280" align="center">
        <template slot-scope="scope">
<!--          <el-button type="primary" @click="selectCourse(scope.row.id)"></el-button>-->
